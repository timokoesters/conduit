...
pub struct Rooms {
    ...
    pub(super) pdu_cache: Mutex<HashMap<EventId, Arc<PduEvent>>>,
    pub(super) auth_chain_cache: Mutex<HashMap<u64, HashSet<u64>>>,
    pub(super) shorteventid_cache: Mutex<HashMap<u64, EventId>>,
    pub(super) eventidshort_cache: Mutex<HashMap<EventId, u64>>,
    pub(super) statekeyshort_cache: Mutex<HashMap<(EventType, String), u64>>,
    pub(super) shortstatekey_cache: Mutex<HashMap<u64, (EventType, String)>>,
...
impl Rooms {
    ...
    #[tracing::instrument(skip(self))]
    pub fn auth_chain_cache(&self) -> std::sync::MutexGuard<'_, HashMap<u64, HashSet<u64>>> {
